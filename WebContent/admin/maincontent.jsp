...
<html>
    ...
    <body>
        <div id="page-wrapper" style="padding-top: 65px">
           ...
           <h2 style="padding-left: 500px">Welcome to Admin Panel..!! </h2>
								...
								<div class="stats">
                                                                    ...
                                                                    <%
                                                                       ...
                                                                       NewClass obj12 = new NewClass();
                                                                        obj12.rs = obj12.fetch("select count(*) from place_order");
                                                                        while(obj12.rs.next()){
								...
								<div class="stats">
                                                                      ...
                                                                      <%
                                                                       ...
                                                                       NewClass obj2 = new NewClass();
                                                                        obj2.rs = obj2.fetch("select sum(p_price) from place_order");
                                                                        while(obj2.rs.next()){
