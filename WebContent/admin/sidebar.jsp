...
<!-- Placed js at the end of the document so the pages load faster -->
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.jsp"> Admin</a></h1>
			</div>
						...
						<li class="menu-list"><a href="#"><i class="lnr lnr-pencil"></i> <span>Modify Data</span></a>
							<ul class="sub-menu-list">
								...
								<li><a href="modifytable.jsp">Update Table</a></li>
                                                ...
                                                <li class="menu-list"><a href="#"><i class="lnr lnr-book"></i> <span>Add Products</span></a>
							<ul class="sub-menu-list">
								<li><a href="addproducts.jsp">Add Products</a> </li>
								
							</ul>
						</li> 
						<li class="menu-list"><a href="#"><i class="lnr lnr-user"></i> <span>Admin Settings</span></a>
							<ul class="sub-menu-list">
								<li><a href="addadmin.jsp">Add Admin</a> </li>
								<li><a href="removeadmin.jsp">Remove Admin</a></li>
							</ul>
						</li> 
						<li class="menu-list"><a href="#"><i class="lnr lnr-users"></i> <span>Shopkeeper Settings</span></a>
							<ul class="sub-menu-list">
								<li><a href="addshopkeeper.jsp">Add Shopkeeper</a> </li>
								<li><a href="removeshopkeeper.jsp">Remove Shopkeeper</a></li>
							</ul>
						</li> 
