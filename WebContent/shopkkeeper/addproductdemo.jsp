<%-- 
    Document   : addproduct
    Created on : Mar 30, 2016, 12:33:19 AM
    Author     : Shweta
--%>
...
<script type="text/javascript">
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    obj2.rs= obj2.fetch("select * from price_products");
    ...
    out.println(""+x);
            ...
            String role=request.getSession().getAttribute("shopkeeper").toString();
            
            NewClass obj3 = new NewClass();
            obj3.rs= obj3.fetch("select * from price_products where p_code='"+Pcode+"' and shop_name='"+sname+"'");
                 if(obj3.rs!= null){
                     NewClass obj4 = new NewClass();
            
                     String st3 = "update price_products set p_price="+Price+" where p_code='"+Pcode+"' and shop_name = '"+sname+"'";
                     obj4.x = obj4.insert(st3);
                     if(obj4.x==0)  
                        {
                     ...
                     if(obj5.rs!= null){
                            ...
                            String st2 ="Insert into price_products(px_id,p_price,p_code,shop_name,p_id) values ("+x+","+Price+",'"+Pcode+"','"+role+"',"+pid+")";
